...
function App() {
  return (
    <div className="tw-min-h-screen tw-flex tw-flex-col tw-justify-center tw-items-center tw-text-[15px] tw-text-white tw-bg-ir-very-dark-blue">
      <main className="tw-rounded-3xl tw-flex tw-flex-col tw-items-start tw-justify-between tw-h-[24rem] tw-w-[24rem] tw-px-8 tw-py-7 tw-bg-gradient-to-b tw-from-ir-dark-blue tw-to-ir-dark-blue/40">
